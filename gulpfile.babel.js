 ...
 * Task: `Format SCSS`.
 *
 * Format SCSS to order properties alphabeticaly
 *
 */

gulp.task('formatscss', () => {
	return gulp
		.src(config.watchStyles, { allowEmpty: true })
		.pipe(
			postcss(
...
gulp.task(
	'default',
	gulp.parallel('formatscss', 'styles', 'vendorsJS', 'customJS', 'images', browsersync, () => {
		gulp.watch(config.watchPhp, reload); // Reload on PHP file changes.
		gulp.watch(config.watchStyles, gulp.parallel('formatscss'));
